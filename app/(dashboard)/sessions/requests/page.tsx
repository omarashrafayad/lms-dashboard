...
export const metadata: Metadata = {
  title: "Booking Requests | Scholar LMS Admin",
}
  ...
  return (
    <div className="flex flex-col min-h-full">
      <PageHeader
        ...
        description="Review and manage student session booking requests and approvals."
      />
      <main className="flex-1 p-6 md:p-8 flex flex-col gap-6 max-w-[1300px] w-full mx-auto pb-20">
        <div className="bg-white rounded-2xl border border-zinc-200/80 shadow-2xs p-12 flex flex-col items-center justify-center text-center gap-3">
          <div className="size-12 rounded-2xl bg-amber-50 text-[#D97706] flex items-center justify-center">
            <CalendarClock className="size-6 stroke-[2]" />
          </div>
          <h2 className="text-base font-bold text-zinc-900">
            No Pending Booking Requests
          </h2>
          <p className="text-xs text-zinc-500 max-w-sm">
            All current session requests have been processed. You can review scheduled sessions in All Sessions.
          </p>
          <Link
            href="/sessions"
