            ...
            <div className="max-w-md w-full text-center space-y-8">
                <div className="relative">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <div className="w-24 h-24 bg-brand-orange dark:bg-brand-orange/30 rounded-full flex items-center justify-center mb-6">
                            <FileQuestion className="w-12 h-12 text-white dark:text-brand-orange" />
                        </div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                        href="/"
                        className="flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-brand-orange hover:bg-brand-orange/90 md:py-4 md:text-lg transition-all shadow-sm hover:shadow-md"
                    >
