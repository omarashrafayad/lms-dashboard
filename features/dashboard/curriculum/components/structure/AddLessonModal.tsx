...
export interface AddLessonModalProps {
  ...
  unitId: string | null
  onAddLesson: (chapterId: string, unitId: string, title: string) => void
}
...
export function AddLessonModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    if (!title.trim() || !chapterId || !unitId) return
    onAddLesson(chapterId, unitId, title.trim())
    setTitle("")
    onOpenChange(false)
  }
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              placeholder="e.g. Lesson 4 — Word Problems"
